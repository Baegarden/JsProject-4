...
// K리그 로고
const bgImage = await loadImage(`https://w.namu.la/s/ebf2ea0b901171820dd5650880ac135b0c385b592d3e900c6011f27366bfefadb3992e60fa97d59eb5c060ac972d9d96ab06d1e47686b9d9518edb86ed63a43ef004d50405074a613007fc59819a78dd1b8538ecf1df90fcaca1d480623dc997`)
const a = widget.addImage(bgImage)
a.centerAlignImage()
a.imageSize = new Size(40, 40)
...
function createStack(stack, text, width, isTitle) {
    ...
    element.size = new Size(width, 20)
