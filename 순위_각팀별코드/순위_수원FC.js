...
widget.backgroundColor = new Color("#013A70", 1)
...
titleStack.backgroundColor = new Color("#EB0028", 1)
...
for (const item of res.groups[0].ranking){
    ...
    if(Math.abs(ranking - myTeamRanking) <= 2){
        ...
        if (ranking <= 3)
            clStack.backgroundColor = new Color("#EB0028", 1)
        // 강등권 팀 설정
        else if (ranking >= 11)
            clStack.backgroundColor = new Color("#EB0028", 1)
        ...
        underStack.borderColor = new Color("#EB0028", 1)
